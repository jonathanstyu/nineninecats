...
CatRentalRequest.create(cat_id: 2, begin_date: '2013-3-1', end_date: '2013-3-1', status: 'denied')
CatRentalRequest.create(cat_id: 2, begin_date: '2014-3-1', end_date: '2015-3-1', status: 'undecided')
CatRentalRequest.create(cat_id: 3, begin_date: '2013-3-1', end_date: '2013-3-1', status: 'undecided')
